...
# Modified this file:
# https://github.com/Azure/azure-iot-sdk-python/blob/master/device/samples/iothub_client_sample.py
...
receive_context = 0
avg_wind_speed = 10.0
message_count = 1 # How many device data to send at the same time
received_count = 0
...
msg_txt = "{\"deviceId\": \"myPythonDevice\",\"temp\": %.2f,\"hum\": %.2f}"
        ...
        while True:
            ...
            for i in range(0, message_count):
                msg_txt_formatted = msg_txt % (
                    avg_wind_speed + (random.random() * 4 + 2), avg_wind_speed + (random.random() * 4 + 2))
            ...
            n = 0 # Choose frequency to send messages. Now it is 6*10s
            while n < 6:
